...
delimiter ;;
CREATE PROCEDURE `addnewbook`(IN `iType` varchar(100),IN `iTitle` varchar(100),IN `iPages` int,IN `iPrice` double,IN `iBrief` longtext,IN `iAuthor` varchar(100),IN `iNation` varchar(100),IN `iPress` varchar(100))
BEGIN
